...
function data < T = any , V extends object> (object: object, key: string | number | symbol, value: T): V
function data < K extends string | number | symbol, V: any, B extends object > (object: object, data: {
  [key: K]: V
}): B
