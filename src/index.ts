...
class Myjs < TElement = HTMLElement > {
  ...
  on < N extends string,
  E extends Event > (name: N, callback: (this: TElement, event: E) => void): this
  on < N extends string,
  E extends Event > (name: N, selector: string, callback: (this: TElement, event: E) => void): this
  on < N extends string,
  E extends Event > (name: N, selector: any, callback ? : (this: TElement, event: E) => void): this {
    on(this, name, selector, callback)

    return this
  }
  one < N extends string,
  E extends Event > (name: N, callback: (this: TElement, event: E) => void): this
  one < N extends string,
  E extends Event > (name: N, selector: string, callback: (this: TElement, event: E) => void): this
  one < N extends string,
  ...
  css < Prop extends keyof HTMLElement["prototype"]["style"] > (props: Prop[]): Record < Prop,
  ...
  css < Prop extends keyof HTMLElement["prototype"]["style"] > (prop: Prop, value: HTMLElement["prototype"]["style"][Prop]): this;
